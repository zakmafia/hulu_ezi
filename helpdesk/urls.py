...
urlpatterns = [
    ...
    path('delete_priority/<int:priority_id>/', views.delete_priority, name='delete_priority'),
    ...
    path('detail_my_request/<int:my_request_id>/', views.detail_my_request, name='detail_my_request'),
    path('detail_user_request/<int:user_request_id>/', views.detail_user_request, name='detail_user_request'),
    ...
    path('delete_kb/<int:doc_docfile_id>/', views.delete_kb, name='delete_kb'),
