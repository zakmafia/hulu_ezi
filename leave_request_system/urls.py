...
urlpatterns = [
    ...
    path('approval_screen/<int:leave_request_id>/', views.approval_screen, name='approval_screen'),
    path('hr_users_leave_request/', views.hr_users_leave_request, name='hr_users_leave_request'),
    path('hr_approval_screen/<int:leave_request_id>/', views.hr_approval_screen, name="hr_approval_screen"),
    ...
    path('export_report_user/<int:user_id>/', views.export_report_user, name='export_report_user'),
]