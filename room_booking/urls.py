...
urlpatterns = [
    ...
    path('view_room_information/<int:room_id>/', views.view_room_information, name='view_room_information'),

    path('create_booking/', views.create_booking, name='create_booking'),
    path('create_booking_from_room/<int:room_id>/', views.create_booking_from_room, name='create_booking_from_room'),
    ...
    path('cancel_booking_user/<int:info_id>/', views.cancel_booking_user, name='cancel_booking_user'),
    path('cancel_booking_admin/<int:info_id>/<int:room_id>/', views.cancel_booking_admin, name='cancel_booking_admin'),
]
